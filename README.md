...
### What is it?
.bashrc or "**B**ourne-**A**gain **SH**ell **R**un **C**ontrol" runs specified comands everytime you open a bash shell prompt (in layman's terms, open a terminal with bash as your defaut shell)
...
### What is it?
.bash_profile or sometimes .profile, is a set of commands that run whenever you log into a bash shell (in layman's terms, logging into your system with bash as your default shell)
